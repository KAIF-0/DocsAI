...
import { Brain, ArrowLeft, RefreshCw, Loader } from "lucide-react";
...
const SignInOTP = () => {
  ...
  const { userId, verifyOTP, isLoggedIn, email, login, logout } =
    useAuthStore();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="max-w-md w-full space-y-8 text-center bg-gradient-to-br from-black/20 via-black/10 to-black/20 backdrop-blur-3xl rounded-2xl p-8 border border-white/40 shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? <Loader className="animate-spin mx-auto" /> : "Verify"}
            </button>
          </form>
